...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> stackChildrendWidgets = [];
    stackChildrendWidgets.add(
      Positioned(
        top: 0.0,
        left: 0.0,
        width: size.width,
    ...
    if (imgCamera != null) {
      stackChildrendWidgets.addAll(displayBoxesAroundRecognozedObjects(size));
    }
    return SafeArea(
      child: Scaffold(
        ...
        body: Container(
          ...
          color: Colors.black,
          child: Stack(
            children: stackChildrendWidgets,
          ),
        ),
      ),
    );
